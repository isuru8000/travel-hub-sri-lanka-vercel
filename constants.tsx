...
export const HERITAGE_MUSIC_DATA: HeritageMusic[] = [
  ...
  { id: 'm3', type: 'instrument', name: { EN: 'Dawula', SI: 'දවුල' }, description: { EN: 'The rhythmic heartbeat of Sabaragamuwa dancing traditions.', SI: 'සබරගමු නර්න සම්ප්‍රදායේ රිද්මයානුකූල හදගැස්මයි.' }, image: 'https://images.unsplash.com/photo-1508700115892-45ecd05ae2ad?auto=format&fit=crop&w=800&q=80', origin: { EN: 'Sabaragamuwa', SI: 'සබරගමුව' }, significance: { EN: 'Integral to temple ceremonies (Hevisi).', SI: 'පන්සල් වල හේවිසි වාදනය සඳහා අත්‍යවශ්‍ය වේ.' } },
  ...
  { id: 'm6', type: 'instrument', name: { EN: 'Hakgediya', SI: 'හක්ගෙඩිය' }, description: { EN: 'A conch shell blown to announce sacred moments.', SI: 'පූජනීය අවස්ථාවන් දැනුම් දීම සඳහා පිඹින හක්ගෙඩියකි.' }, image: 'https://i.pinimg.com/1200x/ce/b7/d6/ceb7d6e0eba3935d85da2d37f1ee8875.jpg', origin: { EN: 'Ancient Puranas', SI: 'පැරණි පුරාණ කාලය' }, significance: { EN: 'Invokes divine presence and ward off evil.', SI: 'දේව ආශිර්වාදය පතා සහ අසුබ දේ පලවා හැරීමට යොදා ගනී.' } },
...
export const MEDICINE_DATA: TraditionalMedicine[] = [
  ...
  },
  {
    ...
    image: "https://i.pinimg.com/1200x/6e/8c/8e/6e8c8e2f8e1a8e1a8e1a.jpg",
